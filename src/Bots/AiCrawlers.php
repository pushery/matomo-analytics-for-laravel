...
final class AiCrawlers
{
    ...
    public const array TOKENS = [
        ...
        'Manus-User', 'Meta-ExternalAgent', 'Meta-ExternalFetcher', 'Meta-ExternalTest', 'meta-webindexer',
        'MistralAI-User', 'Mozilla-Tabstack', 'MyCentralAIScraperBot', 'NagetBot', 'Navu',
        ...
        'quillbot.com', 'Reflectionbot', 'Retool', 'RyeBot', 'SBIntuitionsBot',
        'Scrapy', 'SemrushBot-OCOB', 'SemrushBot-SWA', 'Shap-User', 'ShapBot',
        'TavilyBot', 'TerraCotta', 'Thinkbot', 'TikTokSpider', 'Timpibot',
        'TongyiBot', 'Trae', 'TwinAgent', 'UseAI', 'VelenPublicWebCrawler',
        'WARDBot', 'Webzio-Extended', 'wpbot', 'WRTNBot', 'YandexAdditional',
        'YandexAdditionalBot', 'YiyanBot', 'YouBot', 'ZanistaBot',
    ];
}
