...
final class AiCrawlers
{
    ...
    public const array TOKENS = [
        ...
        'ExaBot', 'FacebookBot', 'facebookexternalhit', 'Factset_spyderbot', 'FirecrawlAgent',
        'FishBot', 'FriendlyCrawler', 'GeistHaus-PageFetcher', 'Gemini-Deep-Research', 'Google-Agent',
        ...
        'GPTBot', 'HarkBot', 'HenkBot', 'HIFIBot', 'iAskBot',
        'iaskspider', 'IbouBot', 'ICC-Crawler', 'ImagesiftBot', 'imageSpider',
        'img2dataset', 'Instapaper', 'ISSCyberRiskCrawler', 'kagi-fetcher', 'Kernel',
        ...
        'Meta-ExternalFetcher', 'meta-webindexer', 'MistralAI-User', 'Mozilla-Tabstack', 'MyCentralAIScraperBot',
        'NagetBot', 'Navu', 'newsai', 'NotebookLM', 'NovaAct',
        ...
        'QueritBot', 'QuillBot', 'quillbot.com', 'Retool', 'RyeBot',
        'SBIntuitionsBot', 'Scrapy', 'SemrushBot-OCOB', 'SemrushBot-SWA', 'Shap-User',
        'ShapBot', 'TavilyBot', 'TerraCotta', 'Thinkbot', 'TikTokSpider',
        'Timpibot', 'TongyiBot', 'Trae', 'TwinAgent', 'UseAI',
        'VelenPublicWebCrawler', 'WARDBot', 'Webzio-Extended', 'wpbot', 'WRTNBot',
