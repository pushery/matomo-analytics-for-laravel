...
final class AiCrawlers
{
    ...
    public const array TOKENS = [
        ...
        'Devin', 'Diffbot', 'Diffbot-User', 'DoubaoBot', 'DuckAssistBot',
        'EchoboxBot', 'Element451Bot', 'ERNIEBot', 'ExaBot', 'ExaSearchBot',
        'FacebookBot', 'facebookexternalhit', 'Factset_spyderbot', 'FirecrawlAgent', 'FishBot',
        'FriendlyCrawler', 'GeistHaus-PageFetcher', 'Gemini-Deep-Research', 'Google-Agent', 'Google-CloudVertexBot',
        'Google-Extended', 'Google-Firebase', 'Google-Gemini-CLI', 'Google-NotebookLM', 'GoogleAgent-Mariner',
        'GoogleAgent-URLContext', 'GoogleOther', 'GoogleOther-Image', 'GoogleOther-Video', 'GPTBot',
        'HarkBot', 'HenkBot', 'HIFIBot', 'iAskBot', 'iaskspider',
        'IbouBot', 'ICC-Crawler', 'ImagesiftBot', 'imageSpider', 'img2dataset',
        'Instapaper', 'ISSCyberRiskCrawler', 'kagi-fetcher', 'Kernel', 'Kimi-SearchBot',
        'Kimi-User', 'KimiBot', 'KlaviyoAIBot', 'KunatoCrawler', 'laion-huggingface-processor',
        'LAIONDownloader', 'Lightpanda', 'LinerBot', 'LinkupBot', 'Manus-User',
        'Meta-ExternalAgent', 'Meta-ExternalFetcher', 'Meta-ExternalTest', 'meta-webindexer', 'MistralAI-Index',
        'MistralAI-Training', 'MistralAI-User', 'Mozilla-Tabstack', 'MyCentralAIScraperBot', 'NagetBot',
        'Navu', 'newsai', 'NotebookLM', 'NovaAct', 'OAI-AdsBot',
        'OAI-SearchBot', 'omgili', 'Omgilibot', 'opencode', 'PanguBot',
        'Panscient', 'panscient.com', 'Perplexity-User', 'PerplexityBot', 'PetalBot',
        'PhindBot', 'Poggio-Citations', 'QAtechBot', 'QualifiedBot', 'Querit-SearchBot',
        'QueritBot', 'QuillBot', 'quillbot.com', 'QwenBot', 'Reflectionbot',
